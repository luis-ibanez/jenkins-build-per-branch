...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            i: [longOpt: 'jenkins-url-api', required: true, args: 1, argName: 'jenkinsUrlApi', description: "Jenkins URL Api- gradle flag -DjenkinsUrlApi=<jenkinsUrlApi>"],
